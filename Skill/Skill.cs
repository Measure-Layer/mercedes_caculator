...
namespace MapleWPF
{
    internal partial class Skill
    {
        ...
        public static void LoadDefaultCombo()
        {
            ...
            ComboList.Add(new Combo(new List<string> { we, us, rr, ab, lt}));
            ComboList.Add(new Combo(new List<string> { we, us, sr, lt }));
            ComboList.Add(new Combo(new List<string> { we, us, sr, gd }));
            ComboList.Add(new Combo(new List<string> { we, ss, us, ss }));
            ComboList.Add(new Combo(new List<string> { we, ss }));
            ComboList.Add(new Combo(new List<string> { we, us }));
            ComboList[2].HatSecond = 1;
            ComboList[3].HatSecond = 1;
            ComboList[4].HatSecond = 4;
            ComboList[5].HatSecond = 4;
            ComboList[6].HatSecond = 7;
            ComboList[7].HatSecond = 7;
            ComboList[8].HatSecond = 8;
            ComboList[2].HatSecondStr = "1";
            ComboList[3].HatSecondStr = "1";
            ComboList[4].HatSecondStr = "4";
            ComboList[5].HatSecondStr = "4";
            ComboList[6].HatSecondStr = "7";
            ComboList[7].HatSecondStr = "7";
            ComboList[8].HatSecondStr = "8";
            UpdateCombo();
        }
